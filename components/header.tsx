...
const socialLinks = [
  { label: "GitHub", href: "https://github.com/fxlpz", icon: Github },
  { label: "Twitter", href: "https://x.com/FelipeBuffer", icon: Twitter },
  { label: "LinkedIn", href: "https://www.linkedin.com/in/felipe0x01/", icon: Linkedin },
]
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6 py-4">
        ...
        <div
          className={cn(
            "transition-all duration-400 ease-in-out md:hidden bg-background overflow-hidden",
            isMobileMenuOpen ? "max-h-[100vh] opacity-100 pt-4 pb-6" : "max-h-0 opacity-0",
          )}
        >
