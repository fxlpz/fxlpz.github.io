...
export function BlogList({ posts }: BlogListProps) {
  ...
  return (
    <div ref={sectionRef} className="space-y-6">
      {posts.length === 0 && (
        <div className="text-center py-20 rounded-xl border border-dashed border-border/50">
          <p className="font-mono text-sm text-muted-foreground">Nenhum artigo encontrado com esse filtro.</p>
        </div>
      )}
